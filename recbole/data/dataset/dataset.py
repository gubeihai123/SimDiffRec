...
class Dataset:
    ...
    def _load_feat(self, filepath, source):
        ...
        df = pd.read_csv(
            ...
            # filepath, delimiter=field_separator, usecols=usecols, quotechar='"',skipinitialspace=True,escapechar='\\',error_bad_lines=False, dtype=dtype, encoding=encoding, engine='python'
        )
        df.columns = columns
